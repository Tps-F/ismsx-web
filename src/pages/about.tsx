      ...
      <div className=" min-h-screen bg-secondary py-6 sm:py-8 lg:py-12 font-caviardreams">
        <div className="mx-auto max-w-screen-md px-4 md:px-8 ">
          ...
          <p className="mb-6 text-gray-500 sm:text-lg md:mb-8">
              <span className="text-primary font-HeiseiKakuGothic">いっしん / 田中一臣 (Isshin Tanaka)
              <br />
              ...
              <br />
              愛工大名電高校{' '}
              <a href="https://meidenid.com/" target="_blank" className="text-indigo-500 underline transition duration-100 hover:text-indigo-600 active:text-indigo-700">
                  情報デザイン部(AMIDC) 
              </a>
              卒業{' '}
              <br />
              ...
              <br />
              <br />
              お仕事のご相談は <a href="mailto:ismsx.jp@gmail.com" className="text-indigo-500 underline transition duration-100 hover:text-indigo-600 active:text-indigo-700">ismsx.jp@gmail.com</a>、
              <br />
          ...
          <h2 className="mb-2 text-xl font-semibold text-gray-800 sm:text-2xl md:mb-4 text-center">WORKS</h2>
          <br />
          ...
          <blockquote className="mb-6 border-l-4 pl-4 italic text-gray-500 sm:text-lg md:mb-8 md:pl-6">“リスト配置にしてあるけど、何もなしがよければ戻すよー！”</blockquote>
